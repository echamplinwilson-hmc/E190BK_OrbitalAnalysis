...
GM = 2.2032e13  # Mercury mu [m^3/s^2] (could have pulled from spice but like...this easier)
g0 = 9.80665
...
# desats
DT_CRUISE = 12*3600  # 2x a day apparantly barring a few issues mid mission
...
# thruster group dataclass 
# (easier to instantiate individual groups cause i was changing properties a lotttt)
@dataclass
class ThrusterGroup:
    name: str
    thrust_N: float
...
# Gradual ion desat every DT_CRUISE before MOI
...
# Mark key events on mass plot for disussions
